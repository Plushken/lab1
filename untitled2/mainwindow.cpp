...
void MainWindow::paintEvent(QPaintEvent *e)
{
    ...
    painter.drawRect(120,215,300,300);
    painter.setPen(color_2);
    painter.setBrush(color_2);
    painter.drawRect(449,215,300,300);
    painter.setPen(color_3);
    painter.setBrush(color_3);
    painter.drawRect(770,215,300,300);
}
...
{
    ui->statusbar->showMessage("Information about conversions");

    QMessageBox::about(this,"Information about conversions","RGB receive 3 values from 0 to 255 \n \n XYZ recieve 3 values from 0.0 to 1.0 \n \n"
